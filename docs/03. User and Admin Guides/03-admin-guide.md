...
Already written up separately: see [3.4 Offline / LAN Mode](04-offline-mode.md)
...
- [3.2 User Guide](02-user-guide.md) – what your students see.
- [4.9 Deployment & Ops](../04. Developer Overview/09-deployment-and-ops.md) – the operational reference behind this guide.
- [4.5 Lanes & Provisioning](../04. Developer Overview/05-lanes-and-provisioning.md) – what actually happens during a deploy.
- [4.7 Crucible & Challenges](../04. Developer Overview/07-crucible-challenges.md) – challenges, events, and attachable challenges.
