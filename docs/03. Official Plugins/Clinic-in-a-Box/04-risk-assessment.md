...
[10 – API Reference](10-api-reference.md#clinic-risk-assessment-apiclinic-risk-assessment).
...
The CIS RAM section ([05](05-cis-ram.md)) is loaded best-effort — if those rows
...
Continue to **[05 – CIS RAM Workbook](05-cis-ram.md)**.
