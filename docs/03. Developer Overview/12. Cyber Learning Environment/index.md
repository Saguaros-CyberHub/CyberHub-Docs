# 3.12 Cyber Learning Environment (CLE)
...
!!! note "Not yet expanded"
    ...
    [Clinic-in-a-Box](../11. Clinic-in-a-Box/index.md) has. The summary in
    [3.10 – Plugins](../10-plugins.md) is currently the
    fullest account.
...
- [3.10 – Plugins: CiaB & CLE](../10-plugins.md) – both plugins side by side.
- [3.4 – Modules & Plugins](../04-modules-and-plugins.md) – how plugins load and get their database.
- [3.5 – Lanes & Provisioning](../05-lanes-and-provisioning.md) – the lane system CLE provisions into.
