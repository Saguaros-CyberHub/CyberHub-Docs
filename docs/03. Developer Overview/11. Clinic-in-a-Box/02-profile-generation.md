...
| `POST /api/profiles/generate-and-deploy` | admin | One-step generate then deploy lanes ([08](08-lane-deployment.md)) |
...
Continue to **[03 – Intakes](03-intakes.md)**.
