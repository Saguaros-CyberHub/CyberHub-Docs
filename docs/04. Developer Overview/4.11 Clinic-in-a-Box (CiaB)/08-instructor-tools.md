...
([01](02-architecture.md)). A group is a `deployed_groups` row whose `config`
...
see [08 – Lane Deployment](09-lane-deployment.md).

Continue to **[08 – Lane Deployment](09-lane-deployment.md)**.
