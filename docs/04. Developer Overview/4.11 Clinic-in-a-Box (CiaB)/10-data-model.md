...
See [03 – Intakes](04-intakes.md) for the payload shape and the two legacy
...
by CyberCore ([4.8 – Auth & Security](../08-auth-and-security.md)).
...
Continue to **[10 – API Reference](11-api-reference.md)**.
