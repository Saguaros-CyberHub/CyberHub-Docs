...
For what each piece does, see [4.9 Deployment & Ops](../04. Developer Overview/09-deployment-and-ops.md).
To run without a public domain, see [3.4 Offline / LAN Mode](../03. User and Admin Guides/04-offline-mode.md).
...
[environment variable reference](../04. Developer Overview/09-deployment-and-ops.md#environment-variable-reference).
...
- [4.1 Overview](../04. Developer Overview/01-overview.md) – what you just
  installed, and the vocabulary the rest of the docs use.
- [4.5 Lanes & Provisioning](../04. Developer Overview/05-lanes-and-provisioning.md) – deploy your first lane.
- [4.9 Deployment & Ops](../04. Developer Overview/09-deployment-and-ops.md) – logging, operational gotchas, and the migration story.
